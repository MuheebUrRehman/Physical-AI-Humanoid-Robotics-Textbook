...
Gather context to ensure thorough validation:

| Source | Gather |
|--------|--------|
| **Codebase** | The skill directory structure: SKILL.md, references/, scripts/, assets/ |
| **Conversation** | Which skill to validate, any specific criteria the user wants focused on |
| **Skill References** | Detailed criteria from `references/detailed-criteria.md`, scoring examples from `references/scoring-examples.md` |
| **User Guidelines** | Any project-specific quality standards or requirements |

Ensure the skill directory exists and is readable before starting validation. Ask user which skill to validate if not specified.
