...
description: |
  Creates production-grade, reusable skills that extend agent capabilities.
...
Create production-grade skills that extend agent capabilities.
...
User: "Create a skill for X"
       ↓
This meta-skill provides guidance to the invoking agent
       ↓
...
This skill provides **guidance and structure** for creating skills. The invoking agent:
