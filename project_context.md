...
- **Tooling**: gemini cli + [Spec-Kit Plus](https://github.com/panaversity/spec-kit-plus/)
...
6. **Bonus — gemini cli Subagents/Skills**: Use reusable gemini cli subagents and agent skills throughout the build
